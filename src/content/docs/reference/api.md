...
- `GET /api/notifications` — in-app notifications (console bell), newest-first with unread count
- `POST /api/notifications/read` — mark the listed notifications read (everything shown when the bell was opened)
